...
Program: Step_D: Deconvolution_Wang_et_al_withoutTCR.py
Purpose: Deconvolution of Wang et al., 2023 using built PBMC atlas without Cancer Reactive T cells.
--------------------------------------------------------------------------------
Data Inputs:
...
nnls_df_Wang = pd.DataFrame(nnls_results_Wang, columns=["CD4+T", "CD8+T", "B", "Mono", "NK"])
