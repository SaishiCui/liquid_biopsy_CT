...
Program: Step_D: Deconvolution_Li_et_al_withTCR.py
Purpose: Deconvolution of Li et al., 2024 using built PBMC atlas with Cancer Reactive T cells.
--------------------------------------------------------------------------------
Data Inputs:
...
Data Outputs:
- Deconvolution results (with TCR) under the data folder "Li_et_al".

<<<<<<< HEAD
=======
Visualization analysis:
- Boxplot of deconvolution results (with TCR) under the data folder "Li_et_al".

>>>>>>> bb3e26c (Initial commit)
Functions:
- constrained_ls(): Deconvolution of Li et al., 2024 using built PBMC atlas with Cancer Reactive T cells.
--------------------------------------------------------------------------------
"""
...
# Find the intersected probes between Atlas and Li et al., 2024
...
nnls_df_Li = pd.DataFrame(nnls_results_Li, columns=["CD4+T", "CD4+TCR", "CD8+T", "CD8+TCR", "B", "Mono", "NK"])
...
nnls_df_Li_TCR = nnls_df_Li.copy()
nnls_df_Li_TCR.to_csv('/Users/scui2/DNAmethylation/Li_et_al/nnls_df_Li_TCR.csv', index = False)
